...
class TEMPOService:
    ...
    async def get_tempo_data(self, city: str) -> Dict[str, Any]:
        ...
        """
        # Always use enhanced mock data to avoid session management issues
        # In production, implement proper async session handling
    ...
    def _get_enhanced_mock_data(self, city: str, lat: float, lon: float) -> Dict[str, Any]:
        ...
        Focused on North American cities where TEMPO operates.
        """
        import random
        ...
        # North American city-specific pollution factors
        pollution_factors = {
            # US Major Cities
            ...
            # Legacy support for non-TEMPO cities
            'New York': {'base_factor': 2.8, 'industrial': True, 'coastal': False},
            'mumbai': {'base_factor': 2.4, 'industrial': True, 'coastal': True},
            'london': {'base_factor': 1.4, 'industrial': False, 'coastal': False},
            'paris': {'base_factor': 1.5, 'industrial': False, 'coastal': False},
        }
    ...
    def get_city_coordinates(self, city: str) -> tuple:
        ...
        Updated to focus on North American cities where TEMPO data is available.
        """
        # North American city coordinate mapping (TEMPO coverage area)
        city_coords = {
            # United States
            ...
            # Legacy support for non-NA cities (will use mock data)
            "New York": (28.6139, 77.2090),
